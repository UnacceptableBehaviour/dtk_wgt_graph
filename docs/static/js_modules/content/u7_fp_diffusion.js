// run - to build standalone static page run
// canvas-sketch u7_fp_diffusion.js --dir public --build --no-compress
// it imports dependencies into file
...
cl(`random.range: ${random.range(1, 10)}`)
